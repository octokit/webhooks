...
The update script is scraping [GitHub’s Webhooks Event Types & Payloads](https://docs.github.com/v3/activity/events/types/) documentation page and extracts the meta information using [cheerio](https://www.npmjs.com/package/cheerio).
